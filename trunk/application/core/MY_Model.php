...
class MY_Model extends CI_Model{
	...
	{		
		...
		$config['smtp_host']='ssl://smtp.googlemail.com';  //'ssl://mail.bitus.com.kh';
		$config['smtp_port']='465';  
		$config['smtp_timeout']='60';  
		$config['smtp_user']='svakhg@gmail.com';  
		$config['smtp_pass']='092730538';  
	...
	public function get_email_by_user($user_id){
		$email = '';
		$data = $this->get_data_by('tbl_user','user_id',$user_id);
		if($data!=null){
			$email = $data->email;
		}		
		return $email;
