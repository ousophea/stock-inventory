		...
		echo '<table>';
			...
			echo '<tr>';
				echo '<td>Code</td><td>:</td><td>';					 
					...
					$data = array('name'=>'code','value'=>$val);
			...
			echo '<tr>';
				echo '<td>Serial Number <span class="require">*</span></td><td>:</td><td>';					 
					...
					$data = array('name'=>'serialNumber','value'=>$val);
				echo form_input($data).'</td>';
			echo '</tr>';
